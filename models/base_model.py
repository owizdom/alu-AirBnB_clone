#!/usr/bin/python3
"""_summary_
    This module cotains the {BaseModel} class - A class that defines
...
class BaseModel:
    ...
    def __init__(self, *args, **kwargs):
        # I had to import storage inside here because i'll get a
        # circular importation error if it is at the top level
        from models import storage
        """_summary_
            This is the constructor method for initializing instances
            of our BaseModel
            args(tuple): it is a tuple of all positional arguments
            kwargs(dict): It is a dictionary containing all key-word
            arguments.
        """
        if len(kwargs) == 0:
            self.id = str(uuid4())
    ...
    def __str__(self):
        """_summary_
            Returns the string representation of BaseModel object in
    ...
    def to_dict(self):
        """_summary_
            ...
            - a key __class__ is added with the class name of the
            object
